...
<xsl:template match="params">
	...
	<div class="style-custom" style="display: none">
		...
		<div class="rule">
			...
			<span class="rule-static">width: <xsl:value-of select="$main.nTabWidth"/>px; height: <xsl:value-of select="$main.nTabHeight"/>px; padding: <xsl:value-of select="tab_padding_tb"/>px <xsl:value-of select="tab_padding_lr"/>px; border-width: <xsl:value-of select="tab_border_width"/>px;</span>
		...
		<div class="rule">
			...
			<span class="rule-static">height: <xsl:value-of select="$main.nTabHeight"/>px; width: <xsl:value-of select="$main.nTabWidth"/>px; <xsl:value-of select="$main.sTabFontCSS"/></span>
		</div>
		...
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-text-v</xsl:attribute>
			<span class="rule-static">height: <xsl:value-of select="$main.nTabHeight"/>px; width: <xsl:value-of select="$main.nTabWidth"/>px;</span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-text-h</xsl:attribute>
			<span class="rule-static">height: <xsl:value-of select="$main.nTabWidth"/>px; width: <xsl:value-of select="$main.nTabHeight"/>px; top: <xsl:value-of select="0.5*number($main.nTabHeight)"/>px;</span>
			<span class="rule-dynamic">
				<xsl:attribute name="data-type">transform-origin</xsl:attribute>
				<xsl:attribute name="data-value">left top</xsl:attribute>
			</span>
			<span class="rule-dynamic">
				<xsl:attribute name="data-type">transform</xsl:attribute>
				<xsl:attribute name="data-value">rotate(270deg)</xsl:attribute>
			</span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-idle  .cl-tab-table-cell, #<xsl:value-of select="$objectID"/> .cl-tab-over  .cl-tab-table-cell</xsl:attribute>
			<span class="rule-static">color: <xsl:value-of select="$main.sTabColorFont"/>;</span>
		</div>
		<xsl:if test="count(elements/item)!=0">
			<div class="rule">
				<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-desc</xsl:attribute>
				<span class="rule-static">width: <xsl:value-of select="$main.nDescWidth"/>px; height: <xsl:value-of select="$main.nDescHeight"/>px; padding: <xsl:value-of select="desc_padding"/>px; border-width: <xsl:value-of select="desc_border_width"/>px; border-color: <xsl:value-of select="$main.sDescBorderColor"/>; background-color: <xsl:value-of select="$main.sDescColor1"/>;</span>
				<xsl:if test="shadow_strength!='none'">
					<span class="rule-dynamic">
						<xsl:attribute name="data-type">box-shadow</xsl:attribute>
						<xsl:attribute name="data-value"><xsl:value-of select="$main.sShadowString"/></xsl:attribute>
			...
			<div class="rule">
				<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-desc-text</xsl:attribute>
				<span class="rule-static">width: <xsl:value-of select="$main.nDescWidth"/>px; height: <xsl:value-of select="$main.nDescHeight"/>px;</span>
			</div>
		</xsl:if>
		<xsl:for-each select="elements/item">
			<div class="rule">
				<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-<xsl:value-of select="position()"/></xsl:attribute>
				<span class="rule-static"><xsl:choose><xsl:when test="../../tab_type='v'">left: 0; top: <xsl:value-of select="websoft:arrayElem(string($main.arTabTops), position(), '|')"/>px;</xsl:when><xsl:otherwise>top: 0; left: <xsl:value-of select="websoft:arrayElem(string($main.arTabLefts), position(), '|')"/>px;</xsl:otherwise></xsl:choose></span>
			</div>
			<div class="rule">
				<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-desc-<xsl:value-of select="position()"/></xsl:attribute>
				<span class="rule-static"><xsl:choose><xsl:when test="../../tab_type='v'">left: 0; top: <xsl:value-of select="websoft:arrayElem(string($main.arTabTopsIdle), (position()+1), '|')"/>px;</xsl:when><xsl:otherwise>top: 0; left: <xsl:value-of select="websoft:arrayElem(string($main.arTabLeftsIdle), (position()+1), '|')"/>px;</xsl:otherwise></xsl:choose></span>
			</div>
			<xsl:if test="../../tab_color_scheme='spec'">
				...
				<div class="rule">
					<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-idle-<xsl:value-of select="position()"/> .cl-tab-table-cell, #<xsl:value-of select="$objectID"/> .cl-tab-over-<xsl:value-of select="position()"/> .cl-tab-table-cell</xsl:attribute>
			...
			<xsl:if test="../../tab_color_scheme_selected='spec'">
				...
				<div class="rule">
					<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-selected-<xsl:value-of select="position()"/> .cl-tab-table-cell</xsl:attribute>
	...
	<div>
		...
		<xsl:attribute name="data-tops"><xsl:value-of select="$main.arTabTopsIdle"/></xsl:attribute>
		<xsl:attribute name="data-lefts"><xsl:value-of select="$main.arTabLeftsIdle"/></xsl:attribute>
		<xsl:attribute name="data-desc-step">
			<xsl:choose>
				<xsl:when test="tab_type='v'"><xsl:value-of select="number($main.nDescHeight) + 2*(number(desc_border_width) + number(desc_padding)) + number($main.nInterTab)"/></xsl:when>
				<xsl:otherwise><xsl:value-of select="number($main.nDescWidth) + 2*(number(desc_border_width) + number(desc_padding)) + number($main.nInterTab)"/></xsl:otherwise>
			</xsl:choose>
		</xsl:attribute>
		<div>
