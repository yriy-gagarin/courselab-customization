...
<xsl:template match="params">
	...
	<div class="style-custom" style="display: none">
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-selector</xsl:attribute>
			<span class="rule-static">width: <xsl:value-of select="$width"/>px; height: <xsl:value-of select="$height"/>px; padding: <xsl:value-of select="padding"/>px; text-align: <xsl:value-of select="text_align" />; border-width: <xsl:value-of select="border_width" />px; border-color: <xsl:value-of select="$border-color-fixed" />; border-style: <xsl:value-of select="border_style" />; background-color: <xsl:value-of select="$bg-color-fixed" />; <xsl:value-of select="$main.sFontCSS" /></span>
		...
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-selector option</xsl:attribute>
			<span class="rule-static">background-color: <xsl:value-of select="$bg-color-fixed" />; <xsl:value-of select="$main.sFontCSS" /></span>
		</div>
	</div>
	<div>
		<xsl:attribute name="class">cl-container unselectable</xsl:attribute>
		<select>
			<xsl:attribute name="id"><xsl:value-of select="$objectID"/>_SELECT</xsl:attribute>
			<xsl:attribute name="data-title-disabled"><xsl:value-of select="alt_disabled"/></xsl:attribute>
			<xsl:attribute name="class">cl-selector</xsl:attribute>
			<option></option>
		</select>
	</div>
</xsl:template>
