...
<xsl:template match="params">
	...
	<div class="style-custom" style="display: none">
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-wrapper</xsl:attribute>
			<span class="rule-static">font-family: <xsl:value-of select="$service-font-family"/>;</span>
		</div>
		<div class="rule">
