...
<xsl:template match="params">
	...
	<div class="style-custom" style="display: none">
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-timer-table td</xsl:attribute>
			<span class="rule-static"><xsl:value-of select="$_css_font"/></span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-timer-limit</xsl:attribute>
			<span class="rule-static">color: <xsl:value-of select="$limit-font-color-fixed"/>;</span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-timer-timer</xsl:attribute>
			<span class="rule-static">color: <xsl:value-of select="$timer-font-color-fixed"/>;</span>
		</div>
	</div>
	<div>
