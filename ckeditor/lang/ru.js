...
CKEDITOR.lang['ru'] = {
	...
	"common": {
		...
		/*added*/
		"borderstyleNone": "без границы",
		"borderstyleSolid": "сплошная",
		"borderstyleDotted": "точечная",
		"borderstyleDashed": "пунктирная",
		"borderstyleHidden": "скрытая",
		"borderstyleDouble": "двойная",
		"borderstyleGroove": "вдавленная",
		"borderstyleRidge": "выпуклая",
		"borderstyleInset": "поднимающаяся",
		"borderstyleOutset": "опускающаяся",
		"borderstyleInitial": "начальная",
		"borderstyleInherit": "наследуемая"
	},
	"basicstyles": {
		"bold": "Полужирный",
		"italic": "Курсив",
	...
	"lineheight": {
		"title": "Междустр.интервал"
	},
	"codemirror": {
		"toolbar": "Источник",
		"searchCode": "Искать в коде",
		"autoFormat": "Форматировать код выбранного фрагмента",
		"commentSelectedRange": "Закомментировать выбранный фрагмент",
		"uncommentSelectedRange": "Снять комментирование с выбранного фрагмента",
		"autoCompleteToggle": "Автозавершение тэгов HTML"
	},
	"texttransform": {
		"transformTextSwitchLabel": "Изменить регистр циклически",
		"transformTextToLowercaseLabel": "Привести к нижнему регистру",
		"transformTextToUppercaseLabel": "Привести к верхнему регистру",
		"transformTextCapitalizeLabel": "Первая буква заглавная"
	},
	"toolbar": {
